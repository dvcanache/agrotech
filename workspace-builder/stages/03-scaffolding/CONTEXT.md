...
| Template | `/_core/templates/workspace-agents-template.md` | Full file | Template for the workspace AGENTS.md (includes What to Load section) |
...
4. Create the workspace AGENTS.md using the template: folder map, triggers, routing table, and What to Load section mapping each task to its minimal file set
...
10. If skills were selected during discovery, create a skills/ folder:
    - For local skills (found in `~/.agents/skills/`): copy the entire skill folder into `skills/[skill-name]/`
