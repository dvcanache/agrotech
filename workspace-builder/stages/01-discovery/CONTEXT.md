...
8. Discover relevant skills. Based on the domain, search for agent skills that would give agents domain-specific knowledge:
   a. Scan `~/.agents/skills/` for locally installed skills that match the domain
   b. Search GitHub for popular skill repos (e.g., "remotion skill", "pptx skill", "[domain] agent skill")
